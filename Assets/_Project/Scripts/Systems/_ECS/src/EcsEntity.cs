...
namespace Blast.ECS {
    ...
    public static class EcsEntityExtensions {
...
#endif
        [MethodImpl (MethodImplOptions.AggressiveInlining)]
        public static Entity Replace<T> (in this Entity entity, in T item) where T : struct {
            Get<T> (entity) = item;
            return entity;
        }
...
#endif
        [MethodImpl (MethodImplOptions.AggressiveInlining)]
        public static void MoveTo (in this Entity source, in Entity target) {
#if DEBUG
...
#endif
        [MethodImpl (MethodImplOptions.AggressiveInlining)]
        public static int GetComponentIndexInPool<T> (in this Entity entity) where T : struct {
            ref var entityData = ref entity.Owner.GetEntityData (entity);
#if DEBUG
            if (entityData.Gen != entity.Gen) { throw new Exception ("Cant check component on destroyed entity."); }
#endif
        ...
        /// </summary>
        [MethodImpl (MethodImplOptions.AggressiveInlining)]
        public static int GetInternalId (in this Entity entity) {
            return entity.Id;
        }
        ...
        /// </summary>
        [MethodImpl (MethodImplOptions.AggressiveInlining)]
        public static bool AreEquals (in this Entity lhs, in Entity rhs) {
            return lhs.Id == rhs.Id && lhs.Gen == rhs.Gen;
        }
        ...
        /// </summary>
        [MethodImpl (MethodImplOptions.AggressiveInlining)]
        public static bool AreIdEquals (in this Entity lhs, in Entity rhs) {
        ...
        /// </summary>
        public static int GetInternalGen (in this Entity entity) {
            return entity.Gen;
        }
        ...
        [MethodImpl (MethodImplOptions.AggressiveInlining)]
        public static EcsComponentRef<T> Ref<T> (in this Entity entity) where T : struct {
            ref var entityData = ref entity.Owner.GetEntityData (entity);
#if DEBUG
...
#endif
        [MethodImpl (MethodImplOptions.AggressiveInlining)]
        public static bool IsWorldAlive (in this Entity entity) {
...
#endif
        [MethodImpl (MethodImplOptions.AggressiveInlining)]
        public static int GetComponentsCount (in this Entity entity) {
            ref var entityData = ref entity.Owner.GetEntityData (entity);
#if DEBUG
            if (entityData.Gen != entity.Gen) { throw new Exception ("Cant touch destroyed entity."); }
#endif
        ...
        public static int GetComponentTypes (in this Entity entity, ref Type[] list) {
            ref var entityData = ref entity.Owner.GetEntityData (entity);
#if DEBUG
            if (entityData.Gen != entity.Gen) { throw new Exception ("Cant touch destroyed entity."); }
#endif
        ...
        /// <param name="list">List to put results in it. if null - will be created. If not enough space - will be resized.</param>
        /// <returns>Amount of components in list.</returns>
        public static int GetComponentValues (in this Entity entity, ref object[] list) {
            ref var entityData = ref entity.Owner.GetEntityData (entity);
#if DEBUG
            if (entityData.Gen != entity.Gen) { throw new Exception ("Cant touch destroyed entity."); }
#endif
